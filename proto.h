...
double min_distance_to_plane(double, double, double, int);
...
int compare_points_by_lat(const void *, const void *);
int compare_points_by_lon(const void *, const void *);
int compare_by_distance(const void *, const void *);
void print_results(result_array_t *, const char *);
void print_results_file(result_array_t *, FILE *);
/* handle_catalog.c */
void relocate_catalog(struct cat *, struct cat *, struct cat *);
void kostrov_set_defaults(struct kostrov_sum *);
void sum_kostrov_bins(struct cat *, unsigned short, int, unsigned short);
void assemble_bins_based_on_distance(struct cat *, unsigned short, int, unsigned short);
